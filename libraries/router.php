<?php
    ...
    else if((!isset($_SESSION['lang']) && !isset($match['params']['lang'])) || $_SESSION['lang']=='') $_SESSION['lang'] = $optsetting['lang_default'];
    $lang = $_SESSION['lang'];
    /* Slug lang */
	...
	$requick = array(
		...
		//array("tbl"=>"product","field"=>"id","source"=>"product","com"=>"album","type"=>"thu-vien-anh",'menu'=>true),
		/* Video */
		...
		/* Bài viết */
		//array("tbl"=>"news","field"=>"id","source"=>"news","com"=>"ho-so-nang-luc","type"=>"ho-so-nang-luc",'menu'=>true),
		array("tbl"=>"news","field"=>"id","source"=>"news","com"=>"dich-vu","type"=>"dich-vu",'menu'=>true),
		//array("tbl"=>"news","field"=>"id","source"=>"news","com"=>"tuyen-dung","type"=>"tuyen-dung",'menu'=>false),
		//array("tbl"=>"news","field"=>"id","source"=>"news","com"=>"tuyen-dung","type"=>"tuyen-dung",'menu'=>false),
		//array("tbl"=>"news","field"=>"id","source"=>"news","com"=>"chung-nhan","type"=>"chung-nhan",'menu'=>false),
		/* Trang tĩnh */
		array("tbl"=>"static","field"=>"id","source"=>"static","com"=>"gioi-thieu","type"=>"gioi-thieu",'menu'=>true),
		array("tbl"=>"check","field"=>"id","source"=>"check","com"=>"check","type"=>"check",'menu'=>false),
		array("tbl"=>"check","field"=>"id","source"=>"checkproduct","com"=>"check-product","type"=>"check-product",'menu'=>false),
		/* Liên hệ */
	...
	switch($com)
	{
		...
		case 'dich-vu':
			$source = "news";
			$template = isset($_GET['id']) ? "news/news_detail" : "service/service";
			$seo->setSeo('type',isset($_GET['id']) ? "article" : "object");
			$type = $com;
			$title_crumb = "dịch vụ";
			break;
