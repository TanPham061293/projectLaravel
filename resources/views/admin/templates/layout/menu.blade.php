...
<aside class="main-sidebar sidebar-dark-primary elevation-4 text-sm">
    ...
    {{-- <a class="brand-link" href="index.php">
        <img class="brand-image" src="" onthis="this.src='thumbs/100x100x1/upload/photo/noimage.png';" alt="">
    </a> --}}
        ...
        <nav class="mt-3">
            <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent text-sm" data-widget="treeview"
                ...
                {{-- <li class="nav-item <?= $active ?>">
                    <a class="nav-link <?= $active ?>" href="index" title="Bảng điều khiển">
                ...
                <li class="nav-item has-treeview menu-group">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item has-treeview <?= $menuopen ?> <?= $none ?>">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item <?= $none ?>"><a class="nav-link <?= $active ?>"
                                        ...
                                        title="Danh mục hãng"><i class="nav-icon text-sm far fa-caret-square-right"></i>
                                        <p>Danh mục hãng</p>
                                    </a></li>
                                <?php } ?>
                                <?php if(isset($v['coupon']) && $v['coupon'] == true) {
                                            $none = "";
                                            $active = "";
                                            if(isset($kiemtra) && $kiemtra == true) if($func->check_access('product', 'man_coupon', $k, null, 'phrase-1')) $none = "d-none";
                                            if($com=='product' && ($act=='man_coupon' || $act=='add_coupon' || $act=='edit_coupon') && $k==$_GET['type']) $active = "active"; ?>
                                <li class="nav-item <?= $none ?>"><a class="nav-link <?= $active ?>"
                                        href="index.php?com=product&act=man_coupon&type=<?= $k ?>"
                                        title="Danh mục mã giảm giá"><i
                                            class="nav-icon text-sm far fa-caret-square-right"></i>
                                        <p>Danh mục mã giảm giá</p>
                                    </a></li>
                                <?php } ?>
                                ...
                                $active = '';
                                if (isset($kiemtra) && $kiemtra == true) {
                                    if ($func->check_access('product', 'man', $k, null, 'phrase-1')) {
                                        $none = 'd-none';
                                    }
                                }
                        ...
                        $menuopen = '';
                        if (isset($kiemtra) && $kiemtra == true) {
                            if ($func->check_access('news', 'man_list', $k, null, 'phrase-1') && $func->check_access('news', 'man_cat', $k, null, 'phrase-1') && $func->check_access('news', 'man_item', $k, null, 'phrase-1') && $func->check_access('news', 'man_sub', $k, null, 'phrase-1') && $func->check_access('news', 'man', $k, null, 'phrase-1')) {
                                $none = 'd-none';
                            }
                        }
                        ...
                        <li class="nav-item has-treeview <?= $menuopen ?> <?= $none ?>">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                $active = '';
                                if (isset($kiemtra) && $kiemtra == true) {
                                    if ($func->check_access('news', 'man', $k, null, 'phrase-1')) {
                                        $none = 'd-none';
                                    }
                                }
                                if ($com == 'news' && ($act == 'man' || $act == 'add' || $act == 'edit' || $act == 'copy' || $kind == 'man') && $k == $_GET['type']) {
                                    $active = 'active';
                                }
                                ?>
                                <li class="nav-item <?= $none ?>"><a class="nav-link <?= $active ?>"
                        ...
                        $active = '';
                        if (isset($kiemtra) && $kiemtra == true) {
                            if ($func->check_access('tags', 'man', $k, null, 'phrase-1')) {
                                $none = 'd-none';
                            }
                        }
                        if ($com == 'tags' && $k == $_GET['type']) {
                            $active = 'active';
                        }
                        ?>
                        <li class="nav-item <?= $none ?>">
                        ...
                        $active = '';
                        if (isset($kiemtra) && $kiemtra == true) {
                            if ($func->check_access('static', 'capnhat', $k, null, 'phrase-1')) {
                                $none = 'd-none';
                            }
                        }
                        ...
                        $active = '';
                        if (isset($kiemtra) && $kiemtra == true) {
                            if ($func->check_access('newsletter', 'man', $k, null, 'phrase-1')) {
                                $none = 'd-none';
                            }
                        }
                        if ($com == 'newsletter' && $k == $_GET['type']) {
                            $active = 'active';
                        }
                        ?>
                        <li class="nav-item <?= $none ?>">
                ...
                <li class="nav-item has-treeview  <?= $menuopen ?> <?= $none ?>">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        @endphp
                        <li class="nav-item <?= $none ?>"><a class="nav-link <?= $active ?>"
                                href="{{ route('getlist') }}" title="Danh mục cấp 1"><i
                                    class="nav-icon text-sm far fa-caret-square-right"></i>
                                <p>Danh mục cấp 1</p>
                            </a></li>
                        <?php } ?>
                        <?php if(isset($v['cat']) && $v['cat'] == true) {
                                    ...
                                    if($com=='product' && ($act=='man_cat' || $act=='add_cat' || $act=='edit_cat' || $kind=='man_cat') && $k==$_GET['type']) $active = "active"; ?>
                        <li class="nav-item <?= $none ?>"><a class="nav-link <?= $active ?>"
                                href="product?act=man_cat&type=<?= $k ?>" title="Danh mục cấp 2"><i
                                    class="nav-icon text-sm far fa-caret-square-right"></i>
                                <p>Danh mục cấp 2</p>
                            </a></li>
                        <?php } ?>
                        <?php if(isset($v['item']) && $v['item'] == true) {
                                    ...
                                    if($com=='product' && ($act=='man_item' || $act=='add_item' || $act=='edit_item' || $kind=='man_item') && $k==$_GET['type']) $active = "active"; ?>
                        <li class="nav-item <?= $none ?>"><a class="nav-link <?= $active ?>"
                                href="product?act=man_item&type=<?= $k ?>" title="Danh mục cấp 3"><i
                                    class="nav-icon text-sm far fa-caret-square-right"></i>
                                <p>Danh mục cấp 3</p>
                            </a></li>
                        <?php } ?>
                        <?php if(isset($v['sub']) && $v['sub'] == true) {
                                    ...
                                    if($com=='product' && ($act=='man_sub' || $act=='add_sub' || $act=='edit_sub' || $kind=='man_sub') && $k==$_GET['type']) $active = "active"; ?>
                        <li class="nav-item <?= $none ?>"><a class="nav-link <?= $active ?>"
                                href="product?act=man_sub&type=<?= $k ?>" title="Danh mục cấp 4"><i
                                    class="nav-icon text-sm far fa-caret-square-right"></i>
                                <p>Danh mục cấp 4</p>
                            </a></li>
                        <?php } } ?>
                        <?php if(isset($v['brand']) && $v['brand'] == true) {
                                    ...
                                    if($com=='product' && ($act=='man_brand' || $act=='add_brand' || $act=='edit_brand') && $k==$_GET['type']) $active = "active"; ?>
                        <li class="nav-item <?= $none ?>"><a class="nav-link <?= $active ?>"
                                href="product?act=man_brand&type=<?= $k ?>" title="Danh mục hãng"><i
                                    class="nav-icon text-sm far fa-caret-square-right"></i>
                                <p>Danh mục hãng</p>
                            </a></li>
                        <?php } ?>
                        ...
                        <?php if(isset($v['coupon']) && $v['coupon'] == true) {
                                    ...
                                    if($com=='product' && ($act=='man_coupon' || $act=='add_coupon' || $act=='edit_coupon') && $k==$_GET['type']) $active = "active"; ?>
                        <li class="nav-item <?= $none ?>"><a class="nav-link <?= $active ?>"
                                href="product?act=man_coupon&type=<?= $k ?>" title="Danh mục mã giảm giá"><i
                                    class="nav-icon text-sm far fa-caret-square-right"></i>
                                <p>Danh mục mã giảm giá</p>
                            </a></li>
                        <?php } ?>
                        ...
                        <?php if(isset($v['mau']) && $v['mau'] == true) {
                                    ...
                                    if($com=='product' && ($act=='man_mau' || $act=='add_mau' || $act=='edit_mau') && $k==$_GET['type']) $active = "active"; ?>
                        <li class="nav-item <?= $none ?>"><a class="nav-link <?= $active ?>"
                                href="product?act=man_mau&type=<?= $k ?>" title="Danh mục màu sắc"><i
                                    class="nav-icon text-sm far fa-caret-square-right"></i>
                                <p>Danh mục màu sắc</p>
                            </a></li>
                        <?php } ?>
                        <?php if(isset($v['size']) && $v['size'] == true) {
                                    ...
                                    if($com=='product' && ($act=='man_size' || $act=='add_size' || $act=='edit_size') && $k==$_GET['type']) $active = "active"; ?>
                        <li class="nav-item <?= $none ?>"><a class="nav-link <?= $active ?>"
                                href="product?act=man_size&type=<?= $k ?>" title="Danh mục kích thước"><i
                                    class="nav-icon text-sm far fa-caret-square-right"></i>
                                <p>Danh mục kích thước</p>
                            </a></li>
                        <?php } ?>
                        ...
                        @php
                        $url = Request::path();
                        if (Str::contains($url, 'Item')) {
                            $active = 'active';
                        } 
                    @endphp
                        <li class="nav-item <?= $none ?>"><a class="nav-link <?= $active ?>"
                                href="{{ route('getitems') }}" title="<?= $v['title_main'] ?>"><i
                                    class="nav-icon text-sm far fa-caret-square-right"></i>
                                <p><?= $v['title_main'] ?></p>
                            </a></li>
                        <?php if(isset($v['import']) && $v['import'] == true) {
                                    ...
                                    if(($com=='import') && ($k==$_GET['type'])) $active = "active"; ?>
                        <li class="nav-item <?= $none ?>">
                            <a class="nav-link <?= $active ?>" href="import?act=man&type=<?= $k ?>" title="Import"><i
                                    class="nav-icon text-sm far fa-caret-square-right"></i>
                                <p>Import</p>
                            </a>
                        </li>
                        ...
                        <?php if(isset($v['export']) && $v['export'] == true) {
                                    ...
                                    if(($com=='export') && ($act=='man') && ($k==$_GET['type'])) $active = "active"; ?>
                        <li class="nav-item <?= $none ?>">
                            <a class="nav-link <?= $active ?>" href="export?act=man&type=<?= $k ?>" title="Export"><i
                                    class="nav-icon text-sm far fa-caret-square-right"></i>
                                <p>Export</p>
                            </a>
                        </li>
                ...
                ?>
                <li class="nav-item has-treeview <?= $menuopen ?> <?= $none ?>">
                    <a class="nav-link <?= $active ?>" href="news?act=man&type=tin-tuc"
                        title="Quản lý <?= $v['title_main'] ?>">
                        <i class="nav-icon text-sm fas fa-book"></i>
                        <p>
                            Tin tức - Sự kiện
                        </p>
                ...
                $menuopen = '';
                if (isset($kiemtra) && $kiemtra == true) {
                    if ($func->check_access('news', 'man', '', $config['news'], 'phrase-2')) {
                        $none = 'd-none';
                    }
                }
                ...
                ?>
                <li class="nav-item has-treeview <?= $menuopen ?> <?= $none ?>">
                    <a class="nav-link <?= $active ?>" href="news?act=man&type=dich-vu" title="Quản lý bài viết">
                ...
                <!-- Statistical config-type-product.php-->
                <?php if(isset($config['statistical']['active']) && $config['statistical']['active'] == true) { ?>
                <?php
                $none = '';
                $active = 'active';
                if (isset($kiemtra) && $kiemtra == true) {
                    if ($func->check_access('statistical', 'man', '', null, 'phrase-1')) {
                        $none = 'd-none';
                    }
                }
                if ($com == 'statistical') {
                ...
                ?>
                <li class="nav-item <?= $active ?> <?= $none ?>">
                    <a class="nav-link <?= $active ?>" href="statistical?act=man" title="Quản lý thống kê">
                        <i class="nav-icon text-sm fas fa-shopping-bag"></i>
                ...
                $menuopen = '';
                if (isset($kiemtra) && $kiemtra == true) {
                    if ($func->check_access('tags', 'man', '', $config['tags'], 'phrase-2')) {
                        $none = 'd-none';
                    }
                }
                ...
                <li class="nav-item has-treeview <?= $menuopen ?> <?= $none ?>">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        ?>
                        <li class="nav-item <?= $none ?>">
                            <a class="nav-link <?= $active ?>" href="tags?act=man&type=<?= $k ?>"
                                title="<?= $v['title_main'] ?>"><i
                                    class="nav-icon text-sm far fa-caret-square-right"></i>
                                <p><?= $v['title_main'] ?></p>
                            </a>
                ...
                $menuopen = 'menu-open';
                if (isset($kiemtra) && $kiemtra == true) {
                    if ($func->check_access('static', 'capnhat', '', $config['static'], 'phrase-2')) {
                        $none = 'd-none';
                    }
                }
                ...
                <li class="nav-item has-treeview <?= $menuopen ?> <?= $none ?>">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        ?>
                        <li class="nav-item <?= $none ?>">
                            <a class="nav-link <?= $active ?>" href="{{route('updateStatic',['type'=>$k])}}"
                                title="<?= $v['title_main'] ?>"><i
                                    class="nav-icon text-sm far fa-caret-square-right"></i>
                                <p><?= $v['title_main'] ?></p>
                            </a>
                ...
                $menuopen = 'menu-open';
                if (isset($kiemtra) && $kiemtra == true) {
                    if ($func->check_access('photo', 'photo_static', '', $config['photo']['photo_static'], 'phrase-2') && $func->check_access('photo', 'man_photo', '', $config['photo']['man_photo'], 'phrase-2')) {
                        $none = 'd-none';
                    }
                }
                ...
                <li class="nav-item has-treeview <?= $menuopen ?> <?= $none ?>">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <?php foreach($config['photo']['photo_static'] as $k => $v) { if(!isset($disabled['photo_static'][$k])) {
                                    ...
                                    ?>
                        <li class="nav-item <?= $none ?>">
                            <a class="nav-link <?= $active ?>" href="{{ route('editPhoto2', ['type' => $k]) }}"
                                title="<?= $v['title_main'] ?>"><i
                                    class="nav-icon text-sm far fa-caret-square-right"></i>
                                <p><?= $v['title_main'] ?></p>
                            </a>
                        ...
                        <?php foreach($config['photo']['man_photo'] as $k => $v) { if(!isset($disabled['photo'][$k])) {
                                    ...
                                    // if($com=='photo' && $_GET['type']==$k && ($act=='man_photo' || $act=='add_photo' || $act=='edit_photo')) $active = "active"; ?>
                        <li class="nav-item <?= $none ?>">
                            <a class="nav-link <?= $active ?>" href="{{ route('getlistPhoto', ['type' => $k]) }}"
                                title="<?= $v['title_main_photo'] ?>"><i
                                    class="nav-icon text-sm far fa-caret-square-right"></i>
                                <p><?= $v['title_main_photo'] ?></p>
                            </a>
                ...
                $menuopen = 'menu-open';
                if (isset($kiemtra) && $kiemtra == true) {
                    if ($func->check_access('places', 'man_city', '', null, 'phrase-1') && $func->check_access('places', 'man_district', '', null, 'phrase-1') && $func->check_access('places', 'man_wards', '', null, 'phrase-1') && $func->check_access('places', 'man_street', '', null, 'phrase-1')) {
                        $none = 'd-none';
                    }
                }
                if ($com == 'places') {
                ...
                <li class="nav-item has-treeview <?= $menuopen ?> <?= $none ?>">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        $active = '';
                        if (isset($kiemtra) && $kiemtra == true) {
                            if ($func->check_access('places', 'man_city', '', null, 'phrase-1')) {
                                $none = 'd-none';
                            }
                        }
                        if ($com == 'places' && ($act == 'man_city' || $act == 'add_city' || $act == 'edit_city')) {
                            $active = 'active';
                        }
                        ?>
                        <li class="nav-item <?= $none ?>">
                            <a class="nav-link <?= $active ?>" href="places?act=man_city" title="Tỉnh thành"><i
                                    class="nav-icon text-sm far fa-caret-square-right"></i>
                                <p>Tỉnh thành</p>
                            </a>
                        </li>
                        ...
                        $active = '';
                        if (isset($kiemtra) && $kiemtra == true) {
                            if ($func->check_access('places', 'man_district', '', null, 'phrase-1')) {
                                $none = 'd-none';
                            }
                        }
                        if ($com == 'places' && ($act == 'man_district' || $act == 'add_district' || $act == 'edit_district')) {
                            $active = 'active';
                        }
                        ?>
                        <li class="nav-item <?= $none ?>">
                            <a class="nav-link <?= $active ?>" href="places?act=man_district" title="Quận huyện"><i
                                    class="nav-icon text-sm far fa-caret-square-right"></i>
                                <p>Quận huyện</p>
                            </a>
                        </li>
                        ...
                        $active = '';
                        if (isset($kiemtra) && $kiemtra == true) {
                            if ($func->check_access('places', 'man_wards', '', null, 'phrase-1')) {
                                $none = 'd-none';
                            }
                        }
                        if ($com == 'places' && ($act == 'man_wards' || $act == 'add_wards' || $act == 'edit_wards')) {
                            $active = 'active';
                        }
                        ?>
                        <li class="nav-item <?= $none ?>">
                            <a class="nav-link <?= $active ?>" href="places?act=man_wards" title="Phường xã"><i
                                    class="nav-icon text-sm far fa-caret-square-right"></i>
                                <p>Phường xã</p>
                            </a>
                        </li>
                        ...
                        $active = '';
                        if (isset($kiemtra) && $kiemtra == true) {
                            if ($func->check_access('places', 'man_street', '', null, 'phrase-1')) {
                                $none = 'd-none';
                            }
                        }
                        if ($com == 'places' && ($act == 'man_street' || $act == 'add_street' || $act == 'edit_street')) {
                            $active = 'active';
                        }
                        ?>
                        <li class="nav-item <?= $none ?>">
                            <a class="nav-link <?= $active ?>" href="places?act=man_street" title="Đường"><i
                                    class="nav-icon text-sm far fa-caret-square-right"></i>
                                <p>Đường</p>
                            </a>
                        </li>
                ...
                <li class="nav-item has-treeview <?= $menuopen ?> <?= $none ?>">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item"><a class="nav-link <?= $active ?>" href="user?act=permission_group"
                                title="Nhóm quyền"><i class="nav-icon text-sm far fa-caret-square-right"></i>
                                <p>Nhóm quyền</p>
                            </a></li>
                        <?php } ?>
                        <?php
                        ...
                        ?>
                        <li class="nav-item"><a class="nav-link <?= $active ?>" href="user?act=admin_edit"
                        ...
                        <li class="nav-item"><a class="nav-link <?= $active ?>" href="user?act=man_admin"
                        ...
                        <li class="nav-item"><a class="nav-link <?= $active ?>" href="user?act=man"
                ...
                $active = '';
                if (isset($kiemtra) && $kiemtra == true) {
                    if ($func->check_access('pushOnesignal', 'man', '', null, 'phrase-1')) {
                        $none = 'd-none';
                    }
                }
                if ($com == 'pushOnesignal') {
                    $active = 'active';
                }
                ?>
                <li class="nav-item <?= $active ?> <?= $none ?>">
                    <a class="nav-link <?= $active ?>" href="pushOnesignal?act=man" title="Quản lý thông báo đẩy">
                ...
                $menuopen = '';
                if (isset($kiemtra) && $kiemtra == true) {
                    if ($func->check_access('seopage', 'capnhat', '', $config['seopage']['page'], 'phrase-2')) {
                        $none = 'd-none';
                    }
                }
                if ($com == 'seopage') {
                ...
                <li class="nav-item has-treeview <?= $menuopen ?> <?= $none ?>">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        $active = '';
                        if (isset($kiemtra) && $kiemtra == true) {
                            if ($func->check_access('seopage', 'capnhat', $k, null, 'phrase-1')) {
                                $none = 'd-none';
                            }
                        }
                        if ($com == 'seopage' && $k == $_GET['type']) {
                            $active = 'active';
                        }
                        ?>
                        <li class="nav-item <?= $none ?>">
                            <a class="nav-link <?= $active ?>" href="seopage?act=capnhat&type=<?= $k ?>"
                ...
                $active = '';
                if (isset($kiemtra) && $kiemtra == true) {
                    if ($func->check_access('setting', 'capnhat', '', null, 'phrase-1')) {
                        $none = 'd-none';
                    }
                }
                if ($com == 'setting') {
                ...
                ?>
                {{-- <li class="nav-item <?= $active ?> <?= $none ?>">
                    <a class="nav-link <?= $active ?>" href="setting?act=capnhat" title="Thiết lập thông tin">
