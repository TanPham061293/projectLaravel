...
@php 
    $infor = Request::path() == 'admin/addphoto' ? 'Thêm mới ' : 'Chỉnh sửa ';
...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <form method="post" novalidate action="{{ route('savePhoto', compact('type', 'id', 'page')) }}"
                ...
                <div class="card card-primary card-outline text-sm">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <label class="change-photo" for="file0">
                                ...
                                <div class="photoUpload-zone">
                                    ...
                                    <div class="photoUpload-dimension"><strong class="d-block mt-2 mb-2 text-sm">Width: 1349
                                            px - Height: 620 px
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="link" id="link0" placeholder="Link">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control form-control-mini d-inline-block align-middle"
                                min="0" name="stt" id="stt0" placeholder="Số thứ tự" value="1">
                                    ...
                                    <div class="tab-pane fade show active" id="tabs-lang-vi-0" role="tabpanel"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ isset($item->tenvi) ? $item->tenvi : '' }}" required>
                                            @error('tenvi')
